...
from agents.agent_bing import BingSearchAgent 
...
async def start():
    ...
    # IMPORTANT: for openai models use gpt-4o-2024-08-06 or gpt-4o
    ...
    bing_agent = BingSearchAgent(                               #change: adding bing_agent
        name="bing_agent",
        server="openai",
        model="gpt-4o",
        temperature=0,
        api_key="1310bd588649492eb45927da4769d447",
    ...
    cl.user_session.set("bing_agent", bing_agent)                           #change: add bing_agent to section
...
async def main(message: cl.Message):
    ...
    #change: add bing_agent to section
    ...
    agent_team = [meta_agent,bing_agent, serper_shopping_agent, web_scraper_agent, offline_rag_websearch_agent, reporter_agent]           #change: bing_agent added insted of serper_agent,
    # agent_team = [meta_agent, serper_agent, offline_rag_websearch_agent, reporter_agent]
    configs = {"recursion_limit": 80, "configurable": {"thread_id": 42}}
